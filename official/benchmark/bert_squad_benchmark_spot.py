...
"""Change: Use local files"""
# pylint: disable=line-too-long
PRETRAINED_CHECKPOINT_PATH = '/data/model/saved_model.pb' # 'gs://cloud-tpu-checkpoints/bert/keras_bert/uncased_L-24_H-1024_A-16/bert_model.ckpt'
SQUAD_TRAIN_DATA_PATH = '/data/squad_v1.1/squad/v1.1/3.0.0/squad-train.tfrecord-00000-of-00001' # 'gs://tf-perfzero-data/bert/squad/squad_train.tf_record'
SQUAD_PREDICT_FILE = '/data/squad_v1.1/squad/v1.1/3.0.0/squad-validation.tfrecord-00000-of-00001' # 'gs://tf-perfzero-data/bert/squad/dev-v1.1.json'
SQUAD_VOCAB_FILE = '/data/model/asset/vocab.txt' # 'gs://tf-perfzero-data/bert/squad/vocab.txt'
SQUAD_MEDIUM_INPUT_META_DATA_PATH = '' # 'gs://tf-perfzero-data/bert/squad/squad_medium_meta_data'
SQUAD_LONG_INPUT_META_DATA_PATH = '/data/squad_v1.1/squad/v1.1/3.0.0/dataset_info.json' # 'gs://tf-perfzero-data/bert/squad/squad_long_meta_data'
SQUAD_FULL_INPUT_META_DATA_PATH = '/data/squad_v1.1/squad/v1.1/3.0.0/dataset_info.json' # 'gs://tf-perfzero-data/bert/squad/squad_full_meta_data'
MODEL_CONFIG_FILE_PATH = '/data/model/keras_metadata.pb' # 'gs://cloud-tpu-checkpoints/bert/keras_bert/uncased_L-24_H-1024_A-16/bert_config.json'
...
class BertSquadBenchmarkReal(BertSquadBenchmarkBase):
  ...
  def benchmark_4_gpu(self):
    """Tests BERT SQuAD model performance with 4 GPU."""
